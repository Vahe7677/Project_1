...
//
    ...
    private func generateProducts() {
        allProducts.append(Product(icon: "barbeque", title: "Barbeque", price: 2500, isFavorite: false))
        allProducts.append(Product(icon: "dolma", title: "Dolma", price: 3000, isFavorite: false))
        allProducts.append(Product(icon: "qeabab", title: "Qeabab", price: 1100, isFavorite: false))
        allProducts.append(Product(icon: "xash", title: "Xash", price: 2000,  isFavorite: false))
